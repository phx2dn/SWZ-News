    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <h6 style = "color:#FFFFFF; font-size:18px;margin-top:16px;margin-left: 1000px;"><%="Welcome "+request.getParameter("username")+"!"%></h6>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container -->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div style="
                    ...
                    <a href="news_comments.jsp?value=<c:out value="${news.id}" />&value2=<%=request.getParameter("username")%>"><c:out value="${news.title}" /></a>
                    </h3>
                <p class="lead">
                    by <a href="news_comments.jsp?value=<c:out value="${news.id}" />"><c:out value="${news.author}" /></a>
                </p>
                <p><span class="glyphicon glyphicon-time"></span> Posted on August 28, 2013 at 10:00 PM</p>
                <p><a href="news_comments.jsp?value=<c:out value="${news.id}" />"><c:out value="${news.description}" /></a></p>
                </div>
                <hr>
                </c:forEach>
